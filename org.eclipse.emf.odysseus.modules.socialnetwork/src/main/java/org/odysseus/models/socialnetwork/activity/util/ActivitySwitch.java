...
public class ActivitySwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ActivityPackage.POST: {
				Post post = (Post)theEObject;
				T result = casePost(post);
				if (result == null) result = caseContribution(post);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ActivityPackage.REACTION: {
				Reaction reaction = (Reaction)theEObject;
				T result = caseReaction(reaction);
				if (result == null) result = caseResponse(reaction);
				if (result == null) result = caseContribution(reaction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ActivityPackage.COMMENT: {
				...
				if (result == null) result = caseResponse(comment);
				if (result == null) result = caseContribution(comment);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ActivityPackage.CONTRIBUTION: {
				Contribution contribution = (Contribution)theEObject;
				T result = caseContribution(contribution);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ActivityPackage.RESPONSE: {
				Response response = (Response)theEObject;
				T result = caseResponse(response);
				if (result == null) result = caseContribution(response);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
