...
public class ActivityFactoryImpl extends EFactoryImpl implements ActivityFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case ActivityPackage.POST: return createPost();
			case ActivityPackage.REACTION: return createReaction();
			case ActivityPackage.COMMENT: return createComment();
			case ActivityPackage.CONTRIBUTION: return createContribution();
			case ActivityPackage.RESPONSE: return createResponse();
			default:
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case ActivityPackage.REACTION_TYPE:
				return createReactionTypeFromString(eDataType, initialValue);
			case ActivityPackage.VISIBILITY:
