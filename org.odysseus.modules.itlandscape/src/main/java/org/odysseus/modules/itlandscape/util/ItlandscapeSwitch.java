 ...
 * @generated
 */
public class ItlandscapeSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case ItlandscapePackage.PHYSICAL_MACHINE: {
			...
			if (result == null)
				result = caseHost(physicalMachine);
			if (result == null)
				result = caseElement(physicalMachine);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ItlandscapePackage.CLUSTER: {
			...
			if (result == null)
				result = caseVirtualHost(cluster);
			if (result == null)
				result = caseHost(cluster);
			if (result == null)
				result = caseElement(cluster);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ItlandscapePackage.VIRTUAL_MACHINE: {
			...
			if (result == null)
				result = caseVirtualHost(virtualMachine);
			if (result == null)
				result = caseHost(virtualMachine);
			if (result == null)
				result = caseElement(virtualMachine);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case ItlandscapePackage.HOST: {
			Host host = (Host) theEObject;
			T result = caseHost(host);
			if (result == null)
				result = caseElement(host);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ItlandscapePackage.VIRTUAL_HOST: {
			VirtualHost virtualHost = (VirtualHost) theEObject;
			T result = caseVirtualHost(virtualHost);
			if (result == null)
				result = caseHost(virtualHost);
			if (result == null)
				result = caseElement(virtualHost);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ItlandscapePackage.ELEMENT: {
