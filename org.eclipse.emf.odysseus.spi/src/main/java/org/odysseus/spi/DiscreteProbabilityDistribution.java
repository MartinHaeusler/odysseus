...
public class DiscreteProbabilityDistribution<E> implements ProbabilityDistribution<E> {
	...
	public static <E> DiscreteProbabilityDistributionBuilder<E> builder(final RandomGenerator random) {
		return new DiscreteProbabilityDistributionBuilder<E>(random);
	}
	...
	/* default */ DiscreteProbabilityDistribution(final Map<E, Double> normalizedDistribution,
